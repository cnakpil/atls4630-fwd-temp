...
})({"gv7Yr":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "2d3b0fc594d0614a";
...
function newDiv(dataReturned, key, status) {
    ...
    for(let i1 = 0; i1 < statusButton.length; i1++){
...
function writeNote(text) {
    var notesListRef = (0, _database.ref)(db, "notes");
    var newNote = (0, _database.push)(notesListRef);
    (0, _database.set)(newNote, {
        text: text,
        done: false
    });
...
},{"@firebase/app":"3AcPV","@firebase/database":"cQryS","../assets/trash.svg":"40ZM9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3AcPV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initializeApp(_options, rawConfig = {}) {
    ...
    if (!options) throw ERROR_FACTORY.create("no-options" /* NO_OPTIONS */ );
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cQryS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 */ class LimitedFilter {
    ...
    updateFullNode(oldSnap, newSnap, optChangeAccumulator) {
        ...
        filtered = ChildrenNode.EMPTY_NODE.withIndex(this.index_);
            ...
            let iterator1;
            if (this.reverse_) {
                iterator1 = filtered.getReverseIterator(this.index_);
                startPost = this.rangedFilter_.getEndPost();
                endPost = this.rangedFilter_.getStartPost();
                const indexCompare = this.index_.getCompare();
                cmp = (a, b)=>indexCompare(b, a);
            } else {
                iterator1 = filtered.getIterator(this.index_);
            ...
            while(iterator1.hasNext()){
                ...
                if (!foundStartPost && cmp(startPost, next1) <= 0) // start adding
                foundStartPost = true;
                const inRange1 = foundStartPost && count1 < this.limit_ && cmp(next1, endPost) <= 0;
                if (inRange1) count1++;
                else filtered = filtered.updateImmediateChild(next1.name, ChildrenNode.EMPTY_NODE);
            }
        }
 ...
 */ function queryParamsToRestQueryStringParameters(queryParams) {
    ...
    qs["orderBy" /* ORDER_BY */ ] = (0, _util.stringify)(orderBy);
    if (queryParams.startSet_) {
        qs["startAt" /* START_AT */ ] = (0, _util.stringify)(queryParams.indexStartValue_);
        if (queryParams.startNameSet_) qs["startAt" /* START_AT */ ] += "," + (0, _util.stringify)(queryParams.indexStartName_);
    }
    if (queryParams.endSet_) {
        qs["endAt" /* END_AT */ ] = (0, _util.stringify)(queryParams.indexEndValue_);
        if (queryParams.endNameSet_) qs["endAt" /* END_AT */ ] += "," + (0, _util.stringify)(queryParams.indexEndName_);
    }
    ...
    if (!writeIdsToExclude && !includeHiddenWrites) {
        ...
        if (!includeHiddenWrites && compoundWriteIsEmpty(merge)) return completeServerCache;
            ...
            if (!includeHiddenWrites && completeServerCache == null && !compoundWriteHasCompleteWrite(merge, newEmptyPath())) return null;
                ...
                const layeredCache1 = completeServerCache || ChildrenNode.EMPTY_NODE;
                return compoundWriteApply(mergeAtPath, layeredCache1);
            }
        }
    }
}
 ...
 */ function writeTreeCalcCompleteEventChildren(writeTree, treePath, completeServerChildren) {
    ...
    if (topLevelSet) {
        ...
        const merge1 = compoundWriteChildCompoundWrite(writeTree.visibleWrites, treePath);
        compoundWriteGetCompleteChildren(merge1).forEach((namedNode)=>{
            completeChildren = completeChildren.updateImmediateChild(namedNode.name, namedNode.node);
        });
        return completeChildren;
    }
 ...
 */ class ChildChangeAccumulator {
    ...
    trackChildChange(change) {
        ...
        (0, _util.assert)(type === "child_added" /* CHILD_ADDED */  || type === "child_changed" /* CHILD_CHANGED */  || type === "child_removed" /* CHILD_REMOVED */ , "Only child changes supported for tracking");
...
function viewProcessorAckUserWrite(viewProcessor, viewCache, ackPath, affectedTree, writesCache, completeCache, accumulator) {
    ...
    if (affectedTree.value != null) {
        ...
        // This is a merge.
        let changedChildren1 = new ImmutableTree(null);
        ...
        return viewProcessorApplyServerMerge(viewProcessor, viewCache, ackPath, changedChildren1, writesCache, completeCache, filterServerNode, accumulator);
    }
}
...
function syncPointApplyOperation(syncPoint, operation, writesCache, optCompleteServerCache) {
    ...
    if (queryId !== null) {
        ...
        let events = [];
        for (const view1 of syncPoint.views.values())events = events.concat(viewApplyOperation(view1, operation, writesCache, optCompleteServerCache));
        return events;
    }
}
/**
 ...
 */ function repoSendTransactionQueue(repo, path, queue) {
    ...
    for(let i = 0; i < queue.length; i++){
        const txn = queue[i];
        (0, _util.assert)(txn.status === 0 /* RUN */ , "tryToSendTransactionQueue_: items in queue should all be run.");
        txn.status = 1 /* SENT */ ;
        txn.retryCount++;
    ...
    if (queue) {
        ...
        for(let i = 0; i < queue.length; i++){
            if (queue[i].status === 3 /* SENT_NEEDS_ABORT */ ) ;
                ...
                (0, _util.assert)(queue[i].status === 0 /* RUN */ , "Unexpected transaction status in abort");
...
},{"@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","process":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"40ZM9":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("3SLf9") + "trash.35f94f46.svg" + "?" + Date.now();
...
},{}]},["gv7Yr","7moXB"], "7moXB", "parcelRequire10ed")

//# sourceMappingURL=index.94d0614a.js.map
